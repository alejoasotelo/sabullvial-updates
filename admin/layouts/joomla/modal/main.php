...
if (isset($params['data-url'])) {
    $modalAttributes['data-url'] = $params['data-url'];
    $modalAttributes['data-url-original'] = $params['data-url-original'];
}

if (isset($params['data-selected_id'])) {
    $modalAttributes['data-selected_id'] = $params['data-selected_id'];
}
...
if (isset($params['url'])) {
    ...
    $script[] = "		var iframe = jQuery('".trim($iframeHtml)."');";
    $script[] = "		var url = $('#$selector').data('url');"; // Cambio para poder cambiar URl del iframe
    $script[] = "		if (url) {iframe.attr('src', url);}";
    $script[] = '       modalBody.prepend(iframe);';
} else {
