...
<?php if (!empty($value)): ?>
	<br/>
	<label>
		<input type="checkbox" id="<?php echo $id . '_delete'?>" name="<?php echo substr($name, 0, -1) . '_delete]'; ?>"> Eliminar archivo 
	</label>
<?php endif; ?>
...
<?php if (!empty($value)): ?>
    <br/>
    <a class="btn btn-small hasTooltip" href="<?php echo $value; ?>">
        <span class="icon-download" aria-hidden="true"></span>
        <?php echo JText::_('COM_SABULLVIAL_DOWNLOAD'); ?>
    </a>
<?php endif; ?>