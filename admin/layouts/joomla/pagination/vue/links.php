...
<div class="pagination pagination-vue pagination-toolbar clearfix">
	...
	<?php if ($showPagesLinks && (!empty($pages))) : ?>
		<ul class="pagination-list">
			<?php
                echo JLayoutHelper::render('joomla.pagination.vue.link', $pages['start']);
	    echo JLayoutHelper::render('joomla.pagination.vue.link', $pages['previous']); ?>
			<?php foreach ($pages['pages'] as $k => $page) : ?>

				<?php $output = JLayoutHelper::render('joomla.pagination.vue.link', $page); ?>
			...
			<?php endforeach; ?>
			<?php
	    echo JLayoutHelper::render('joomla.pagination.vue.link', $pages['next']);
	    echo JLayoutHelper::render('joomla.pagination.vue.link', $pages['end']); ?>
		</ul>
	<?php endif; ?>
