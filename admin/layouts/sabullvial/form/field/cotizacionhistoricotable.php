	...
	<table name="<?php echo $name; ?>" id="<?php echo $id; ?>" class="table table-hover table-striped table-bordered">
		...
		<tbody>
			<?php foreach ($options as $option) : ?>
				<tr>
					<td>
						<span class="label" style="background-color: <?php echo $option->estadocotizacion_bg_color; ?>; color: <?php echo $option->estadocotizacion_color; ?>">
							<?php echo $option->estadocotizacion; ?>
						</span>
					</td>
