...
<tr
	...
	data-parent-id_product="<?php echo $fieldIdProducto->value; ?>"
>
	<?php foreach ($form->getGroup('') as $field) : ?>
		<td data-fieldname="<?php echo strip_tags($field->fieldname); ?>" <?php echo $field->fieldname == 'id_producto' ? 'data-value="'.strip_tags($field->value).'"' : ''; ?> data-column="<?php echo strip_tags($field->label); ?>"
