ALTER TABLE `#__sabullvial_cotizacion` ADD `iibb_revision` DECIMAL(20, 6) NULL AFTER `iibb`;
ALTER TABLE `#__sabullvial_cotizacion` ADD `subtotal_revision` DECIMAL(20, 6) NOT NULL DEFAULT '0.000000' AFTER `subtotal`;
ALTER TABLE `#__sabullvial_cotizacion` ADD `total_revision` DECIMAL(20, 6) NOT NULL DEFAULT '0.000000' AFTER `total`;
