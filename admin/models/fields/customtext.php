 ...
 * @since  0.0.1
 */
class JFormFieldCustomText extends JFormFieldText
{
    /**
     * The field type.
     *
    ...
    protected $addontranslate = false;
    ...
    public function setup(SimpleXMLElement $element, $value, $group = null)
    {
        ...
        if ($result == true) {
            ...
            $this->descriptiontooltip = (string) $this->element['descriptiontooltip'];
            $this->addontranslate = (string) $this->element['addontranslate'];
        }
    ...
    protected function getLayoutData()
    {
        ...
        $addontranslate = in_array($this->addontranslate, ['true', 'false', 0, 1]) ? (bool)$this->addontranslate : false;
