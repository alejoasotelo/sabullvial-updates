 ...
 * @since  0.0.1
 */
class JFormFieldCotizacionHistoricoTable extends JFormFieldList
{
    /**
     * The field type.
     *
     * @var         string
     */
    protected $type = 'CotizacionHistoricoTable';
    ...
    protected function getOptions()
    {
        ...
        $query->select('ch.id, ec.nombre estadocotizacion, ec.color estadocotizacion_bg_color, ec.color_texto estadocotizacion_color, ch.created, ch.created_by_alias');
