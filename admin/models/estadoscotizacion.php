 ...
 * @since  0.0.1
 */
class SabullvialModelEstadosCotizacion extends JModelList
{
    /**
     * Constructor.
     *
    ...
    protected function getListQuery()
    {
        ...
        $query->select('a.id, a.nombre, a.color bg_color, a.color_texto color, a.access, a.published, a.created')
            ->from($db->quoteName('#__sabullvial_estadocotizacion', 'a'));
