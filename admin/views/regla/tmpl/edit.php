...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "regla.cancel" || document.formvalidator.isValid(document.getElementById("adminForm")))
		{
...
$tabActive = $app->getUserState('com_sabullvial.edit.regla.tab', 'general');
...
<form action="<?php echo JRoute::_('index.php?option=com_sabullvial&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm">
    <div class="form-horizontal">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SABULLVIAL_REGLA_DETAILS')); ?>
        <div class="row-fluid">
            <div class="span10">
                <?php
    ...
    <input type="hidden" name="task" value="regla.edit" />
