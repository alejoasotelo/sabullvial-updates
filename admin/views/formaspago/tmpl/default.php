...
?>
<form action="index.php?option=com_sabullvial&view=formaspago" method="post" id="adminForm" name="adminForm">
            ...
            <thead>
                <tr>
                    ...
                    <th style="min-width:100px" class="nowrap">
                        <?php echo JHtml::_('searchtools.sort', 'COM_SABULLVIAL_FORMAS_PAGO_NAME', 'nombre', $listDirn, $listOrder); ?>
                    </th>
            ...
            <tbody>
                <?php if (!empty($this->items)) : ?>
                    <?php foreach ($this->items as $i => $row) : ?>
                        <?php
                            $link = JRoute::_('index.php?option=com_sabullvial&task=formapago.edit&id=' . $row->id);
                        ?>
                        <tr>
                            <td class="center">
                            ...
                            <td class="center">
                                <?php echo JHtml::_('jgrid.published', $row->published, $i, 'formaspago.', true, 'cb'); ?>
                            </td>
                            <td>
