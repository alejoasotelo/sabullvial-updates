 ...
 * @since  0.0.1
 */
class SabullvialViewClientesTango extends JViewLegacy
{
    /**
    ...
    public function display($tpl = null)
    {
        ...
        // Set the submenu
        SabullvialHelper::addSubmenu('clientestango');
    ...
    protected function addToolBar()
    {
        ...
        $title = JText::_('COM_SABULLVIAL_CLIENTES_TANGO_MANAGER');
        ...
        //JToolbarHelper::deleteList('', 'clientes.delete');
