...
<div class="container-popup">
    <form action="index.php?option=com_sabullvial&view=clientestango&layout=modal&tmpl=component" method="post" id="adminForm" name="adminForm">
                            ...
                            <tr>
                                <td>
                                    <a class="pointer button-select" href="#" 
                                        ...
                                        data-cliente-cuit="<?php echo $this->escape($row->cuit); ?>"
