...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <div class="span4 control-group mt-1 mb-3">
            <label class="h4" for="delivered_by_counter_delivery_date"><?php echo JText::_('COM_SABULLVIAL_REMITOS_ADD_REMITO_TO_ROUTE_SHEET_LABEL'); ?></label>
            <small class="text-muted mb-1"><?php echo JText::_('COM_SABULLVIAL_REMITOS_ADD_REMITO_TO_ROUTE_SHEET_DESC'); ?></small>
            <div>
                <select2-ajax data-test-id="hojaderuta"
                    v-model="addRemitosToRouteSheet.id_hojaderuta" 
                    parent="#modalAddRemitoToRouteSheet"
                    track-by="id" 
                    url="index.php?option=com_sabullvial&task=remito.listHojasDeRuta" 
                    class="no-chosen reduce-br modal-cliente"
                    placeholder="- Seleccione una hoja de ruta -"
                    :template-option="templateOptionHojasDeRuta"
                    >
