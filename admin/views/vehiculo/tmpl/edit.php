...
JFactory::getDocument()->addScriptDeclaration('
    ...
    {
        if (task == "vehiculo.cancel" || document.formvalidator.isValid(document.getElementById("adminForm")))
        {
...
$tabActive = $app->getUserState('com_sabullvial.edit.vehiculo.tab', 'general');
...
<form action="<?php echo JRoute::_('index.php?option=com_sabullvial&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <div class="form-horizontal">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SABULLVIAL_VEHICULO_DETAILS')); ?>
            <div class="row-fluid">
                <div class="span10">
                    <?php
    ...
    <input type="hidden" name="task" value="vehiculo.edit" />
