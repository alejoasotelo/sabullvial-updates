...
?>
<form action="index.php?option=com_sabullvial&view=choferes" method="post" id="adminForm" name="adminForm">
			...
			<thead>
				<tr>
					...
					<th style="min-width:100px" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'COM_SABULLVIAL_CHOFERES_NAME', 'name', $listDirn, $listOrder); ?>
					</th>
			...
			<tbody>
				<?php if (!empty($this->items)) : ?>
					<?php foreach ($this->items as $i => $row) :
					    $link = JRoute::_('index.php?option=com_sabullvial&task=chofer.edit&id=' . $row->id);
					    ?>
						<tr>
							<td class="center">
							...
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $row->published, $i, 'choferes.', true, 'cb'); ?>
							</td>
							<td>
				...
				<?php else: ?>
					<tr>
						<td colspan="8" class="center muted">
							<?php echo JText::_('COM_SABULLVIAL_CHOFERES_SIN_CHOFERES'); ?>
						</td>
					</tr>
				<?php endif; ?>
			</tbody>
