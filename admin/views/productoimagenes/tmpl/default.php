...
?>
<form action="index.php?option=com_sabullvial&view=productoimagenes" method="post" id="adminForm" name="adminForm">
            ...
            <thead>
                <tr>
                    ...
                    <th style="min-width:100px" class="nowrap">
                        <?php echo JHtml::_('searchtools.sort', 'COM_SABULLVIAL_PRODUCTO_IMAGENES_NAME', 'name', $listDirn, $listOrder); ?>
                    </th>
            ...
            <tbody>
                <?php if (!empty($this->items)) : ?>
                    <?php foreach ($this->items as $i => $row) :
                        $link = JRoute::_('index.php?option=com_sabullvial&task=productoimagen.edit&id=' . $row->id);
                        ?>
                        <tr>
                            ...
                            <td class="center">
                                <?php echo JHtml::_('jgrid.published', $row->published, $i, 'productoimagenes.', true, 'cb'); ?>
                            </td>
                            <td>
